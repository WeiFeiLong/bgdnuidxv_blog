...
def email_gravatar(email):
    ...
    没注册，根据邮箱后缀，使用不同的头像
    """
    email_fist, email_last = email.split('@')
    email_hash = hashlib.md5(email.lower().encode('utf-8')).hexdigest()
    url = 'http://www.gravatar.com/avatar/' + email_hash + '/?d=404'
    r = requests.get(url)
    email_code = r.status_code
    if email_code is 200:  # 注册过gravatar，句柄返回200
        url = 'http://www.gravatar.com/avatar/' + email_hash + '?s=48&d=mp'
        bbb = 0
    else:
        if email_last == 'qq.com':
            bbb = 1
            url = 'https://www.bgdnuidxv.com/static/login/images/' + 'qq.png'
        elif email_last == 'gmail.com':
            bbb = 2
            url = 'https://www.bgdnuidxv.com/static/login/images/' + 'gmail.png'
        elif email_last == '126.com':
            bbb = 3
            url = 'https://www.bgdnuidxv.com/static/login/images/' + '126.png'
        elif email_last == '163.com':
            bbb = 4
            url = 'https://www.bgdnuidxv.com/static/login/images/' + '163.jpg'
        elif email_last == 'tom.com':
            bbb = 5
            url = 'https://www.bgdnuidxv.com/static/login/images/' + 'tom.jpg'
        else:
            bbb = 10
            url = 'https://www.bgdnuidxv.com/static/login/images/' + 'mail.png'
