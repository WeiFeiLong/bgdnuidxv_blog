        ...
        <div class="container center_content">
            ...
            <form action="." method="post" class="form-horizontal">{% csrf_token %}
                ...
                <div class="text-center">
                    ...
                    {% else %}
                    <input type="submit" name="submit" class="btn btn-primary" value="顶"/>
                    {% endif %}
