...
class XtdCommentForm(CommentForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['name'] = forms.CharField(
            label=_("昵称"),
            widget=forms.TextInput(attrs={'placeholder': '名称',
                                          'class': 'form-control'}))
        self.fields['email'] = forms.EmailField(
            label=_("邮箱"), help_text=_(""),
            widget=forms.TextInput(attrs={'placeholder': '邮箱地址',
                                          'class': 'form-control'}))
        self.fields['url'] = forms.URLField(
            label=_("网址"), required=False,
            widget=forms.TextInput(attrs={
                'placeholder': _('关于你的网址(可选)'),
                'class': 'form-control'}))
        self.fields['comment'] = forms.CharField(
            widget=CKEditorUploadingWidget())    # 引入CKEditor 的表单 
        # widget=forms.Textarea(attrs={'placeholder': _('因您的建议 我在变得更好'),
        #                              'class': 'form-control'}),
