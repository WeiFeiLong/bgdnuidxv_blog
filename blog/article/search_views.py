...
class MySeachView(SearchView):
    def extra_context(self):  # 重载extra_context来添加额外的context内容
        ...
        for p in page.object_list:  # 处理page的数据
            ...
            dict1['content'] = re.sub(r'<[^>]+>', "", markdown.markdown(p.object.content, extensions=[
            ...
            dict1['year'] = time[0:4]  # 年
            dict1['month'] = time[5:7]  # 月
            dict1['day'] = time[8:10]  # 日
            dict1['slug'] = p.object.slug  # 日
